...
class TopicPlayer(PlayerProcess):
    ...
    def __init__(self, mongodb_host, mongodb_port, mongodb_username, mongodb_password, mongodb_authsource, mongodb_certfile,
                 mongodb_ca_certs, mongodb_authmech, db_name, collection_name, event, start_time, end_time):
    ...
    def init(self, running):
        ...
        rospy.init_node("mongodb_playback_%s" % self.collection_name, log_level=rospy.DEBUG)
